                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div className="input-group mb-3" style={{ maxWidth: "120px" }}>
                                                    <div className="input-group-prepend">
                                                        <button className="btn btn-outline-primary js-btn-minus" onClick={decrement} type="button">-</button>
                                                    </div>
                                                    <p className="form-control text-center">{count}</p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div className="input-group mb-3" style={{ maxWidth: "120px" }}>
                                                    <div className="input-group-prepend">
                                                        <button className="btn btn-outline-primary js-btn-minus" onClick={decrement2} type="button">-</button>
                                                    </div>
                                                    <p className="form-control text-center">{count2}</p>
                                                    <div className="input-group-append">
