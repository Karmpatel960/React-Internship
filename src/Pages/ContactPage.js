                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 mb-0">
                            <Link to="/home">Home</Link> <span className="mx-2 mb-0">/</span> <strong className="text-black">Contact</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="site-section">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-12 col-sm-12 col-xl-6 col-lg-6 mt-3">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d317716.6064658049!2d-0.43124526458479395!3d51.52860701118051!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a00baf21de75%3A0x52963a5addd52a99!2sLondon%2C%20UK!5e0!3m2!1sen!2sin!4v1691136103521!5m2!1sen!2sin"
                                width="100%"
                                height="600"
                                style={{ border: 0 }}
                                allowFullScreen=""
